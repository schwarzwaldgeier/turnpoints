#!/bin/bash
curl -H 'Cache-Control: no-cache' "https://www.google.com/maps/d/kml?forcekml=1&mid=1BQW2L9hn454ky5jYWdMswSCpwMk&lid=FXac77ltWUg" -o nordschwarzwald.kml
...
sed -i '/.*<time>.*<\/time>.*/d' nordschwarzwald.gpx
